...
import { LayoutDashboard, ShoppingBag, Sun, Moon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <NavLink to="/" className="flex items-center group">
          <span className="font-heading text-2xl font-black tracking-tight text-slate-900 dark:text-white transition-opacity duration-200 group-hover:opacity-90 select-none">
            Stock<span className="bg-gradient-to-r from-indigo-600 to-pink-500 dark:from-indigo-400 dark:to-pink-400 bg-clip-text text-transparent">Sync</span>
          </span>
        </NavLink>
